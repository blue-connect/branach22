...
class ResConfigSettings(models.TransientModel):
    ...
    pd_authorize_url = fields.Char("Pipedrive Authorize URL", required=True)
    pd_token_url = fields.Char('Pipedrive Token URL', required=True)
    pd_api_url = fields.Char('Pipedrive API URL', required=True)
